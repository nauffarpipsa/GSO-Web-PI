...
<body id="kt_app_body" data-kt-app-layout="light-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                                    ...
                                    <div class="card-header border-0 pt-6">
                                        <div class="card-title">
                                            <div class="d-flex align-items-center position-relative my-1">
                                                ...
                                                <input type="text" id="rolSearch" class="form-control form-control-solid w-250px ps-12" placeholder="Buscar Rol..." />
                                            </div>
                                        </div>
    ...
    <link rel="stylesheet" href="apps\configuraciones\roles\css\roles-grid-responsive.css">

    <!-- CSS específico del módulo Maestro de Préstamos -->
    <link rel="stylesheet" href="apps\configuraciones\roles\css\roles-grid.css">

    <!-- CSS estándar de modales -->
    <link rel="stylesheet" href="assets/css/modal-standard.css">

    <!-- Módulo específico de préstamos -->
    <script type="module" src="apps/configuraciones/roles/js/roles-grid.js"></script>
