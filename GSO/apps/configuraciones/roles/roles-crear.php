...
<head>
    <base href="../../../" />
    <title>Creacion de sociedad</title>
    <meta charset="utf-8" />
...
<body id="kt_app_body" data-kt-app-layout="light-sidebar" data-kt-app-header-fixed="true"
                                    ...
                                    <div class="card-header border-0 pt-6">
                                        ...
                                        <div class="card-toolbar">
                                            <div class="d-flex justify-content-end">
                                                <a href="apps\configuraciones\roles\roles.php" class="btn btn-light me-3">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 mb-3">
                                                        <label for="LegalName" class="form-label fw-bold">Accesos </label>
    ...
    <script type="module" src="apps/configuraciones/roles/js/roles-crear.js"></script>
