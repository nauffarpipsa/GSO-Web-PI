...
<body id="kt_app_body" data-kt-app-layout="light-sidebar" data-kt-app-header-fixed="true"
                            ...
                            <div id="kt_app_content_container" class="app-container container-xxl">
                                ...
                                <div class="card h-100 w-100">
                                    ...
                                    <div class="card-header border-0 pt-6">
                                        ...
                                        <div class="card-toolbar">
                                            <!-- <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                                <button type="button" class="btn btn-light-primary me-3" id="btnUser">
                                    ...
                                    <div class="card-body py-4 d-flex flex-column flex-grow-1">
                                        ...
                                        <div id="userGrid" class="flex-grow-1"></div>
    ...
    <script type="module" src=" apps/configuraciones/users/js/usuario.js"></script>
