...
<body id="kt_app_body" data-kt-app-layout="light-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                            ...
                            <div id="kt_app_content_container" class="app-container container-xxl">
                                ...
                                <div class="card h-100 w-100">
                                    ...
                                    <div class="card-header border-0 pt-6">
                                        <div class="card-title">
                                            <div class="d-flex align-items-center position-relative my-1">
                                                ...
                                                <input type="text" id="companySearch" class="form-control form-control-solid w-250px ps-12" placeholder="Buscar Sociedad..." />
                                            </div>
                                        </div>
                                        <div class="card-toolbar">
                                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                                <button type="button" class="btn btn-light-primary me-3" id="btnNewCompany">
                                    ...
                                    <div class="card-body py-4 d-flex flex-column flex-grow-1">
                                        ...
                                        <div id="sociedadesGrid" class="flex-grow-1"></div>
    ...
    <!--end::Modal de Modificación Rápida-->
    ...
    <link rel="stylesheet" href="apps/configuraciones/sociedades/css/sociedades-responsive.css">

    <!-- CSS específico del módulo Maestro de sociedades -->
    ...
    <script type="module" src="apps/configuraciones/sociedades/js/sociedades-grid.js"></script>
