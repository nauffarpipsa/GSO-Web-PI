...
<head>
    <base href="../../../" />
    <title>Creación de Sociedades</title>
    <meta charset="utf-8" />
...
<body id="kt_app_body" data-kt-app-layout="light-sidebar" data-kt-app-header-fixed="true"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header border-0 pt-6">
                                        <div class="card-title">
                                            <h2 class="fw-bold" id="formSociedadesTitle"> <!-- ID para el título -->
                                                <i class="ki-duotone ki-edit fs-2 me-2"></i>
                                                Creacion de Sociedades
                                            </h2>
                                        </div>
                                        <div class="card-toolbar">
                                            <div class="d-flex justify-content-end">
                                                <a href="apps\configuraciones\Sociedades\sociedades-grid.php" class="btn btn-light me-3">
                                        ...
                                        <form id="formEdicionCompleta">
                                            <div class="card mb-5">
                                                <div class="card-header">
                                                    <h3 class="card-title">Información Sociedad</h3>
                                                </div>
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            <label for="LegalName" class="form-label fw-bold">Nombre
                                                                legal</label>
                                                            <input type="tel" class="form-control" id="LegalName">
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <label for="RTN" class="form-label fw-bold">RTN o Registro
                                                                Tributario</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            <label for="managerId" class="form-label fw-bold">Encardado
                                                                de Sociedades</label>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            <label for="phone" class="form-label fw-bold">Teléfono
                                                                Sociedad</label>
                                                            <input type="tel" class="form-control" id="phone"
                                                                maxlength="20">
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <label for="Website" class="form-label fw-bold">Sitio
                                                                Web</label>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            <label for="logoPathInput" class="form-label fw-bold">Ruta
                                                                de
                                                                logo</label>
                                                            <input type="text" class="form-control" id="logoPathInput">
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <label for="ExternalCurrency"
                                                                class="form-label fw-bold">Moneda
                                                                alternativa</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            <label for="accountingCodeOne"
                                                                class="form-label fw-bold">Codigo contable principal
                                                            </label>
                                                            <input type="text" class="form-control"
                                                                id="accountingCodeOne">
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <label for="accountingCodeTwo"
                                                                class="form-label fw-bold">Codigo contable
                                                                secundario
                                                            </label>
                                                            <input type="text" class="form-control"
                                                                id="accountingCodeTwo">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            <label for="sapCode"
                                                                class="form-label fw-bold">Codigo de sap
                                                            </label>
                                                            <input type="text" class="form-control"
                                                                id="sapCode">
                                                        </div>
    ...
    <link rel="stylesheet" href="apps/configuraciones/sociedades/css/sociedades.css">
    ...
    <script type="module" src="apps/configuraciones/sociedades/js/sociedades-crear.js"></script>
