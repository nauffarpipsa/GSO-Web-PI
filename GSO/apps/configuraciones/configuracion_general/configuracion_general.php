...
<body id="kt_app_body" data-kt-app-layout="light-sidebar" data-kt-app-header-fixed="true"
                                    ...
                                    <div class="row g-5 g-xl-8 mb-5">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="card card-xl-stretch mb-xl-8">
                                                <div class="card-header border-0 pt-5">
                                                    <h3 class="card-title align-items-start flex-column">
                                                        <span class="card-label fw-bold fs-3 mb-1">Configuracion de Reportes
                                                        </span>
                                                        <span class="text-muted mt-1 fw-semibold fs-7">Reportes</span>
                                                    </h3>
                                                    <div class="card-toolbar">
                                                        <button type="button" class="btn btn-sm btn-light-primary"
                                                            id="btnAgregarReportConfiguration">
                                                            <i class="ki-duotone ki-plus fs-2"></i>Agregar
                                                        </button>
                                                    </div>
                                                </div>
                                                <div class="card-body py-3">
                                                    <div id="reportConfigurationGridContainer">
                                                        <div id="reportConfigurationGrid"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <?php include("reportConfigurationModal.php"); ?>
