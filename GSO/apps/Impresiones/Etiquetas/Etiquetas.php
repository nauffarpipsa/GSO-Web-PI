...
<head>
    <base href="../../../" />
    <title>Etiquetas - Nauffar Germany</title>
    <meta charset="utf-8" />
    ...
    <!-- Custom CSS -->
    <link href="apps/Impresiones/Etiquetas/css/etiquetas.css" rel="stylesheet" type="text/css" />
...
<body id="kt_app_body" data-kt-app-layout="light-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header border-0 pt-6">
                                        <div class="card-title">
                                            <div class="d-flex align-items-center position-relative my-1">
                                                ...
                                                <input type="text" id="EtiquetaSearch" class="form-control form-control-solid w-250px ps-12" placeholder="Buscar Etiqueta..." />
                                            </div>
                                        </div>
                                        <div class="card-toolbar">
                                            <div class="d-flex justify-content-end align-items-center" data-kt-user-table-toolbar="base">
                                                <div class="me-3">
                                                    <select id="sede" class="form-select form-select-solid">
                                                        <option value="">Cargando sedes...</option>
                                                    </select>
                                                </div>
                                                <div class="me-3">
                                                    <select id="impresora" class="form-select form-select-solid">
                                    ...
                                    <div class="card-body py-4">
                                        ...
                                        <div class="table-responsive">
                                            <table id="tablaEtiquetas" class="table align-middle table-row-dashed fs-6 gy-5">
                                                <thead>
                                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                                        <th class="min-w-50px">Seleccionar</th>
                                                        <th class="min-w-100px">Lote</th>
                                                        <th class="min-w-150px">Codigo</th>
                                                        <th class="min-w-100px">Descripcion</th>
                                                        <th class="min-w-100px">Sede</th>
                                                        <th class="min-w-100px">Inventario</th>
                                                        <th class="min-w-100px">Cantidad de Etiquetas</th>
    ...
    <script src="apps/Impresiones/Etiquetas/js/helpers.js"></script>
</body>
</html> 