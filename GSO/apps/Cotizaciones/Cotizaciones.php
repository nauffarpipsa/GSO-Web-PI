...
<html lang="es">
  ...
  <head>
    ...
    <link
      rel="canonical"
      href="http://preview.keenthemes.comapps/ecommerce/catalog/products.html"
    />
        ...
        <div id="kt_app_header" class="app-header">
          ...
          >
            ...
            <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
              ...
              include("../../Navigation/MobileLogo.php");
              ?>
            </div>
            <!--end::Mobile logo-->
            ...
            <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper" >
              <!--begin::Menu wrapper-->
                  ...
                  include("../../Navigation/MenuHeader.php");
                    ...
                    document.addEventListener("DOMContentLoaded", function () {
                      ...
                      document.querySelectorAll('.menu-link').forEach(link => {
                        if (link.getAttribute('href') === currentPath) {
                          link.classList.add('active'); // Marca el link como activo
                          // Abre el menú accordion si existe
                          const menuItem = link.closest('.menu-item.menu-accordion');
                          if (menuItem) {
              ...
              <div class="app-navbar flex-shrink-0">
                <?php
                  include("../../Navigation/LoginHeader.php");
                ?>
              </div>
              <!--end::Navbar-->
            </div>
                      ...
                      >
                        <div class="w-100 mw-150px">
                          ...
                          >
                            ...
                            <option value="published">En Caja</option>
                            <option value="scheduled">Anulada</option>
                            <option value="inactive">No Fcturada</option>
                          </select>
                          <!--end::Select2-->
                        </div>
                        <!--begin::Add product-->
                        <a
                          href="apps/Cotizaciones/CrearCotizacion.php"
                          class="btn btn-primary">Nueva Cotización</a>
                        <!--end::Add product-->
                      </div>
                      <!--end::Card toolbar-->
                    </div>
                      ...
                      <table
                        ...
                        <thead>
                          <tr
                            ...
                            <th class="min-w-200px">Cotización</th>
                            <th class="text-end min-w-100px">Cliente</th>
                            <th class="text-end min-w-70px">Fecha</th>
                            <th class="text-end min-w-100px">Almacen Despacho</th>
                            <th class="text-end min-w-100px">Vendedor</th>
                        ...
                        <tbody class="fw-semibold text-gray-600">
                          <tr>
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">02145003</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/2.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">04884003</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/3.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">02857003</span>
                            </td>
                            <td class="text-end pe-0" data-order="46">
                              <span class="fw-bold ms-3">46</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/4.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">04284004</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/5.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">03510009</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/6.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">03225006</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/7.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">02205005</span>
                            </td>
                            <td class="text-end pe-0" data-order="46">
                              <span class="fw-bold ms-3">46</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/8.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">04872004</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/9.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">03441007</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/10.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">03184006</span>
                            </td>
                            <td class="text-end pe-0" data-order="13">
                              <span class="fw-bold ms-3">13</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/11.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">02300002</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/12.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">01839001</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/13.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">02856002</span>
                            </td>
                            <td class="text-end pe-0" data-order="47">
                              <span class="fw-bold ms-3">47</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/14.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">02554005</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/15.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">01734008</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/16.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">04358009</span>
                            </td>
                            <td class="text-end pe-0" data-order="11">
                              <span class="fw-bold ms-3">11</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/17.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">01952005</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/18.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">02166006</span>
                            </td>
                            <td class="text-end pe-0" data-order="46">
                              <span class="fw-bold ms-3">46</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/19.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">01626009</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/20.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">04305009</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/21.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">03611007</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/22.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">04568008</span>
                            </td>
                            <td class="text-end pe-0" data-order="6">
                              <span class="badge badge-light-warning"
                                >Low stock</span
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/23.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">01169002</span>
                            </td>
                            <td class="text-end pe-0" data-order="20">
                              <span class="fw-bold ms-3">20</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/24.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">01682007</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/25.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">01224001</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/26.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">03645003</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/27.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">02114005</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/28.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">04243007</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/29.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">02904005</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/30.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">02744009</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/31.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">01529002</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/32.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">01915003</span>
                            </td>
                            <td class="text-end pe-0" data-order="20">
                              <span class="fw-bold ms-3">20</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/33.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">04563001</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/34.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">03215006</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/35.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">01618002</span>
                            </td>
                            <td class="text-end pe-0" data-order="16">
                              <span class="fw-bold ms-3">16</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/36.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">04923001</span>
                            </td>
                            <td class="text-end pe-0" data-order="36">
                              <span class="fw-bold ms-3">36</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/37.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">03968008</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/38.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">03672004</span>
                            </td>
                            <td class="text-end pe-0" data-order="5">
                              <span class="badge badge-light-warning"
                                >Low stock</span
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/39.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">02405009</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/40.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">04917005</span>
                            </td>
                            <td class="text-end pe-0" data-order="5">
                              <span class="badge badge-light-warning"
                                >Low stock</span
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/41.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/42.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/43.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">01330009</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/44.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">01969001</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/45.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">02782003</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/46.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">04246005</span>
                            </td>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/47.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/48.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">02539006</span>
                            </td>
                          ...
                          <tr>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/49.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">02724009</span>
                            </td>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                >
                                  <span
                                    class="symbol-label"
                                    style="
                                      background-image: url(assets/media//stock/ecommerce/50.png);
                                    "
                                  ></span>
                                </a>
                                <!--end::Thumbnail-->
                ...
                <div class="current" data-kt-stepper-element="content">
                  ...
                  <div class="w-100">
                    ...
                    <div class="pb-10 pb-lg-15">
                      <!--begin::Title-->
                      <h2
                        class="fw-bold d-flex align-items-center text-gray-900"
                      >
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <div class="ms-6">
                              <a
                                href="#"
                                class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2"
                                >Campaign Landing Page Source</a
                              >
                    ...
                    <div class="fv-row mb-10">
                      ...
                      <div class="d-flex gap-9 mb-7">
                        ...
                        >
                          ...
                          <br />
                          <span class="fs-7"
                            >Your ad will run on the specified dates only.</span
                          >
                        </button>
                        <!--end::Button-->
                      </div>
